...
const AuthProvider = ({ children })=>{
    ...
    const login = (userData, tokenData, tenantData)=>{
        setToken(tokenData);
        setUser(userData);
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].logout();
        } catch  {
        // ignore
        } finally{
            setToken(null);
    ...
    const refreshUser = async ()=>{
        try {
            const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"].getMe();
            setUser(updatedUser);
...
api.interceptors.response.use((res)=>res, (err)=>{
    if (("TURBOPACK compile-time value", "undefined") !== 'undefined' && err.response?.status === 401) //TURBOPACK unreachable
    ;
...
const AuthService = {
    async login (payload) {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', payload);
        return res.data.data;
    },
    async registerTenant (payload) {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', payload);
        return res.data.data;
    },
    async getMe () {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/auth/me');
        return res.data.data;
    },
    async logout () {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/logout');
        } catch  {
        // ignore
        }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0hagwt4._.js.map